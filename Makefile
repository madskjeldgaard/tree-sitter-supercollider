LANGUAGE_NAME := tree-sitter-tree-sitter-supercollider
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-tree_sitter_supercollider
VERSION := 0.3.2
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-supercollider '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-supercollider
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/tree-sitter-supercollider
